...
#all necessary matrix or vector operations can be found at https://docs.blender.org/api/current/mathutils.html
    ...
    def createView():
        ...
        Z = (eyePosition-centerPosition) @ mathutils.Matrix.Rotation(radians(-13.0), 4, 'Z') # ze dvou bodu vektor center do eye
        # rotace * pohledovy_vektor
        Z.normalize()
        #Y will be pointing up in the view space
        Y = mathutils.Vector(upVector)
        #X has to be perpendicular to Z and Y
        X = mathutils.Vector(Y.cross(Z)) # kolmy vektor na dva vektory
        #######################
    ...
    def createTransformation(object, view):
        ...
        mat_trans = mathutils.Matrix.Translation((0.0, -objectNumber, 0.0))
        ...
        transformation = view @ mat_rot @ mat_trans
        #######################
        #.....
        #######################
