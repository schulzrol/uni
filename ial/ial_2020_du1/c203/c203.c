...
*/
    // Otazka na zadavtele: Nejasne, jestli ma zustat jeden prvek opravdu nevyuzity, nebo ze to tak ma jen vypadat v API
...
*/
    ...
    // viz. zadani
    return (q == NULL || q->b_index == q->f_index);
}
...
*/
    return (q != NULL && nextIndex(q->b_index) == q->f_index);
}
