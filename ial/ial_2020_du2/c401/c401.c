...
**/
    ...
    // stejný, našli jsme přesně ideální místo, prepisujeme
    (*RootPtr)->BSTNodeCont = Content;
}
...
**/
    ...
    // stopaz - narazili jsme na nejpravejsi uzel
    if ((*RootPtr)->RPtr == NULL) {
        //presuneme hodnoty a i nazev? zadani je celkem ambiugous
        PtrReplaced->BSTNodeCont = (*RootPtr)->BSTNodeCont;
        PtrReplaced->Key = (*RootPtr)->Key;
        // pokud má levé, levé se stane tímto a smažeme minulé
        ...
        // nemá levé (a ani prave, kdyz je nejpravejsi), smažeme
        else {
            free((*RootPtr));
            (*RootPtr) = NULL;
            return;
    ...
    // neni NULL, muzem se posunout doprava
    else
