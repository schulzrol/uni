...
protected:
    ...
    // implementaci.
    //============================================================================//
    PriorityQueue::Element_t *head;

    void RemoveElement(PriorityQueue::Element_t *em);
    void InsertElementAfter(PriorityQueue::Element_t* after, PriorityQueue::Element_t *em);
    void RemoveFirst();
};
