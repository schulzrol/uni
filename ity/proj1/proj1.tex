...
\begin{quotation}
Čím více \textbf{druhů}, \emph{řezů}, {\tiny velikostí}, {\color{green} barev} písma a {\color{blue} \uppercase{jiných efektů}} \underline{použijeme}, {\color{red} tím profesionálněji} bude {\fontfamily{pzc}dokument} vypadat.
